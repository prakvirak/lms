...
<!-- span12 -->
<div class="span12">
<h2><?php echo lang('global_join_member');?></h2>
...
echo form_open('join', $attributes); ?>
    ...
    <input type="text" name="firstname" id="firstname" required value="<?php echo $this->session->userdata['user_nm'] ?>"/><br />
    ...
    <div class="input-append">
        <input type="text" name="login" id="login" required value = "<?php echo $this->session->userdata['user_id']?> "/>
...
<?php }?>
        ...
        $('#send').click(function() {
            if (validate_form() == false) {
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>weusers/check/login",
                data: { login: $("#login").val() }
                })
                .done(function( msg ) {
                    console.log(msg);
